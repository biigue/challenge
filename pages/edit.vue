...
<b-card-body title="Alterar Perfil">
          <b-card-text>
  ...
  <ValidationObserver v-slot="{ invalid }">
    <b-form @submit.prevent="onSubmit">
      ...
      <b-button variant="primary" type="submit" :disabled="invalid">Alterar</b-button>
    </b-form>
  </ValidationObserver>
  </div>
</b-card-text>
...
export default {
  ...
  computed: {
    ...mapState({
      ...
      stateEmail: state => state.email_user,
    }),
  },
  mounted() {
  }
